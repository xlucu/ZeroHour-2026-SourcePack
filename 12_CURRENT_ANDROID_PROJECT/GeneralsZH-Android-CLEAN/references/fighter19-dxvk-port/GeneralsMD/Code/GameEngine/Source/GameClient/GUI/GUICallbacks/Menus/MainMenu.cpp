...
static MessageBoxReturnType checkCDCallback( void *userData )
{
	...
	{
		prepareCampaignGame((GameDifficulty)(uintptr_t)(Int *)userData);
		return MB_RETURN_CLOSE;
	}
}
																		...
																		WindowMsgData mData1, WindowMsgData mData2 )
{
	...
	switch( msg ) 
	{
		...
		{
			ICoord2D mouse;
			mouse.x = (uintptr_t)mData1 & 0xFFFF;
			mouse.y = (uintptr_t)mData1 >> 16;
...
#endif
#else
				// WorldBuilder launch not supported on this platform
				MessageBoxOk(TheGameText->fetch("GUI:WorldBuilder"), TheGameText->fetch("GUI:WorldBuilderNotSupported"),NULL);
#endif
			}
