...
function(GetGitState _working_dir)
    ...
    if(GIT_EXECUTABLE)
        ...
        set(ENV{GIT_IS_DIRTY} "true")
        set(ENV{GIT_HEAD_SHA1} "DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF")
        set(ENV{GIT_AUTHOR_NAME} "Someone")
        set(ENV{GIT_AUTHOR_EMAIL} "someone@someplace.org")
        set(ENV{GIT_COMMIT_DATE_ISO8601} "1955-11-12 22:04:00 +0000")
        set(ENV{GIT_COMMIT_SUBJECT} "Git Not Found")
        set(ENV{GIT_COMMIT_BODY} "\"\"") # empty string.
        set(ENV{GIT_COMMIT_TSTAMP} "0")
