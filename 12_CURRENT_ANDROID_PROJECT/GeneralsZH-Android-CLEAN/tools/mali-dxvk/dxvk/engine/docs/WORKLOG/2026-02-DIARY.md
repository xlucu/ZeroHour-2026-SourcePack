...
- Copied from `references/old-refs/fighter19-dxvk-port/GeneralsMD/Code/GameEngineDevice/`
...
Ported `scaleMouseCoordinates()` from fighter19's reference implementation (`references/old-refs/fighter19-dxvk-port/GeneralsMD/Code/GameEngineDevice/Source/SDL3Device/GameClient/SDL3Mouse.cpp`):
...
### Reference
Same approach as `references/old-refs/fighter19-dxvk-port/` — fighter19's Linux port uses identical hardware hardcoding in `GameLOD.cpp`.
